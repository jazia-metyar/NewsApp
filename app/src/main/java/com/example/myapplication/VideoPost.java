...
public class VideoPost extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(VideoPost.this);
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(FilePathUri!=null){
                    ...
                    Toast.makeText(VideoPost.this, "Please select an image", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
    ...
    private void UploadToFireBase(Uri uri){
        ...
        fileRef.putFile(uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                fileRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        ref.child(postTitle).setValue(post);
                        progressDialog.dismiss();
                        Toast.makeText(VideoPost.this, "uploaded successfully", Toast.LENGTH_LONG).show();
                    }
                });
            }
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(VideoPost.this, "Problem upload", Toast.LENGTH_LONG).show();
            }
        });
    }
